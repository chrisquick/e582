...
def hist_latlon(lats,lons,rads,bin_lats,bin_lons):
    ...
    lat_count,lat_index,lowlats,highlats=bin_lats.do_bins(lats.ravel())    
    lon_count,lon_index,lowlons,highlons=bin_lons.do_bins(lons.ravel())    
        ...
        for the_col in range(cols):
            ...
            if len(rad_list)==0:
                ...
                try:
                    ...
                    lat_vals=np.take(lats.ravel(),rad_list)
                    lon_vals=np.take(lons.ravel(),rad_list)
